...
export interface paths {
    ...
    "/agents/approvers": {
         ...
         * @description The people who may decide in a scope, by name — the same set an
         *     explicitly named person is checked against, so a screen offering the
         *     list offers the list that will be used.
         *
         *     Wider than who a run is announced to when nobody is named: an
         *     administrator holds the approval act and is left out of that broadcast,
         *     because one granted at the installation would be told about every
         *     parked run there is. Naming them is one message to one person whose
         *     button decides.
         *
