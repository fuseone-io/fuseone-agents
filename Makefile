...
check-pg: db
	...
	TEST_DATABASE_URL=$(TEST_DSN) $(GO) test ./internal/ledger/ ./internal/e2e/ ./internal/admin/ ./internal/spec/ ./internal/auth/ ./internal/trigger/ ./internal/audit/ ./internal/policy/ ./internal/scope/ ./internal/authoring/ -count=1 -race -p 1
